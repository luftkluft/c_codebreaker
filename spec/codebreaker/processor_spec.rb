RSpec.describe Processor do
  context 'when testing #guess_comparison method' do
    [
      ['1234', '1234', '++++'], ['1234', '4321', '----'], ['1231', '1234', '+++'],
      ['1134', '1431', '++--'], ['1324', '1234', '++--'], ['1111', '1321', '++'],
      ['1234', '1111', '+'], ['2552', '1221', '--'], ['1234', '2332', '+-'],
      ['4441', '2233', ''], ['1234', '5561', '-'], ['1234', '1342', '+---'],
      ['3211', '1561', '+-'], ['1666', '6661', '++--'], ['1134', '1155', '++'],
      ['1134', '5115', '+-'], ['1134', '5511', '--'], ['1134', '1115', '++'],
      ['1134', '5111', '+-'], ['1234', '1555', '+'], ['1234', '2555', '-'],
      ['1234', '5224', '++'], ['1234', '5154', '+-'], ['1234', '2545', '--'],
      ['1234', '5234', '+++'], ['1234', '5134', '++-'], ['1234', '5124', '+--'],
      ['1234', '5115', '-'], ['1234', '1234', '++++'], ['5143', '4153', '++--'],
      ['5523', '5155', '+-'], ['6235', '2365', '+---'], ['1234', '4321', '----'],
      ['1234', '1235', '+++'], ['1234', '6254', '++'], ['1234', '5635', '+'],
      ['1234', '3525', '--'], ['1234', '2552', '-'], ['1234', '4255', '+-'],
      ['1234', '1524', '++-'], ['1234', '5431', '+--'], ['1234', '6666', ''],
      ['1115', '1231', '+-'], ['1231', '1111', '++'], ['1234', '4326', '---'],
      ...
      it "tests that #{value.first} equals to #{value.last}" do
        expect(subject.guess_comparison(value[1], value[0])).to eq value.last
      end
    end
  end
end
